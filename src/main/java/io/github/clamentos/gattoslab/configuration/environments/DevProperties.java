...
public final class DevProperties extends ApplicationProperties {
    ...
    public DevProperties() {
        ...
        corsConfig = new CorsConfig(true, Set.of("http://localhost:8080", "https://localhost:8443"), 3600);
        databaseConfig = new DatabaseConfig("mongodb://localhost:27017/GattosLabMongoDB", 4, 16, 30, 300, 20, 15);
        ...
        rateLimitConfig = new RateLimitConfig(true, /* 200 */ 9999999, "s10", 60000);
